...
class __Mustache_7e194d6833d1217362009a1f12cde0bc extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section5815db1495745e20f93172cf5a104dbc($context, $indent, $value);
        $buffer .= $indent . '
';
        $value = $context->find('completion');
        $buffer .= $this->section2560fe3979ef89967936ce89a28d61ee($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
    ...
    private function section5815db1495745e20f93172cf5a104dbc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionD2726ade75fb9279eec1a155782af2cf(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section2560fe3979ef89967936ce89a28d61ee(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionD2726ade75fb9279eec1a155782af2cf($context, $indent, $value);
                $context->pop();
            }
        }
