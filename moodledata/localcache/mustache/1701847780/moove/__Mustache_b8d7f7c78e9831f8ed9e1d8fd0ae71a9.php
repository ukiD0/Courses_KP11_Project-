...
class __Mustache_b8d7f7c78e9831f8ed9e1d8fd0ae71a9 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        {% comment %} <button class="btn btn-icon bg-secondary icon-no-margin btn-footer-popover" data-action="footer-popover" aria-label="';
        $value = $context->find('str');
...
';
        ...
        $buffer .= '
';
        $buffer .= $indent . '        </button> {% endcomment %}
';
        $buffer .= $indent . '    </div>
';
